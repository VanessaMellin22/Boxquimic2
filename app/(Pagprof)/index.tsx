     ...
     <Section2>
          ...
          <Subtitle3 >
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Minima maxime quam architecto quo inventore harum ex magni, dicta impedit.
                ...
                <CardContainer>
                 <ImageCont>
                    <StyledImage
                        source={{ uri: '../../assets/images/Banners/question.png' }} // URL temporária
                    />
                </ImageCont>
                <TextContainer>
        ...
        <RoundButton>
            ...
            size={30} />
                ...
                <ImageCont>
                    <StyledImage
                        source={{ uri: '../../assets/images/Banners/pencil.png' }} // URL temporária
                    />
                </ImageCont>
                <TextContainer>
                    <Quote>Edite</Quote>
                ...
                <ImageCont>
                    <StyledImage
                        source={{ uri: '../../assets/images/Banners/delete-file.png' }} // URL temporária
                    />
                </ImageCont>
                <TextContainer>
                    <Quote>Delete</Quote>
